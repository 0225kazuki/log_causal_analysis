...
if __name__ == '__main__':
    ...
    for day in day_set:
        ...
        # new_time_list = np.array([ round(b + 0.01, 3) if round(b) == x else x for b,x in zip(time_list[:-1],time_list[1:])])

        # for i, t in enumerate(time_list*100):
        #     if cur_t == t:
        #         time_list[i] = time_list[i-1]+1
        #     else:
        #         cur_t = t
        ...
        #         t_stck.append(t)
        #     elif len(t_stck) == 1:
        #         new_time_list.extend(t_stck)
        #         t_stck = [t,]
        #         cur_t = t
        #     else:
        #         new_time_list.extend([ round(x + 1./len(t_stck)*num,3) for num,x in enumerate(t_stck) ] )
        #         cur_t = t
        #         t_stck=[t,]
        # else:
        #     new_time_list.extend([ round(x + 1./len(t_stck)*num,3) for num,x in enumerate(t_stck) ] )
